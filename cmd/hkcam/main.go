...
func main() {
	...
	var dataDir *string = flag.String("data_dir", "/var/lib/hkcam/data", "Path to data directory")
	var verbose *bool = flag.Bool("verbose", true, "Verbose logging")
	var pin *string = flag.String("pin", "00102003", "PIN for HomeKit pairing")
	var port *string = flag.String("port", "8080", "Port on which transport is reachable")
